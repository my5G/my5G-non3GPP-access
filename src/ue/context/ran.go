...
func (ue *UeRanContext) CalculateIpv4HeaderChecksum(hdr *ipv4.Header) uint32 {
	var Checksum uint32
...
func (ue *UeRanContext) GetAuthSubscription(k, opc, op string) models.AuthenticationSubscription {
...
func (ue *UeRanContext) GetAccessAndMobilitySubscriptionData() (amData models.AccessAndMobilitySubscriptionData) {
	return TestRegistrationProcedure.TestAmDataTable[TestRegistrationProcedure.FREE5GC_CASE]
}

func (ue *UeRanContext) GetSmfSelectionSubscriptionData() (smfSelData models.SmfSelectionSubscriptionData) {
	return TestRegistrationProcedure.TestSmfSelDataTable[TestRegistrationProcedure.FREE5GC_CASE]
}

func (ue *UeRanContext) GetSessionManagementSubscriptionData() (smfSelData models.SessionManagementSubscriptionData) {
	return TestRegistrationProcedure.TestSmSelDataTable[TestRegistrationProcedure.FREE5GC_CASE]
}

func (ue *UeRanContext) GetAmPolicyData() (amPolicyData models.AmPolicyData) {
	return TestRegistrationProcedure.TestAmPolicyDataTable[TestRegistrationProcedure.FREE5GC_CASE]
}

func (ue *UeRanContext) GetSmPolicyData() (smPolicyData models.SmPolicyData) {
...
func (ue *UeRanContext) GetMobileIdentity5GS() nasType.MobileIdentity5GS {
