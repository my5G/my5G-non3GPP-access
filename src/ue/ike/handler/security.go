...
// Decrypt
func DecryptProcedure(ikeSecurityAssociation *context.IKESecurityAssociation, message *ike_message.IKEMessage, encryptedPayload *ike_message.Encrypted) ([]ike_message.IKEPayloadType, error) {
	// Check parameters
	if ikeSecurityAssociation == nil {
...
func EncodeNasPduWithSecurity(ue *context.UeRanContext, pdu []byte, securityHeaderType uint8,
