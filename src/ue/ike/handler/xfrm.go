...
func ApplyXFRMRule2(n3iwf_is_initiator bool, childSecurityAssociation *n3iwf_context.ChildSecurityAssociation) error {
...
func GetLinkInterfaceByName(ifName string) (netlink.Link, error) {

	var linkIPSec netlink.Link
	links, err := netlink.LinkList()
	if err != nil {
		return nil, errors.New("IPsec Link interface not found.")
	}
