...
import (
	...
	ue_context "free5gc/src/ue/context"
)
...
func setupUDPSocket(ctx *context.UEContext, log *logrus.Entry) *net.UDPConn {
...
func InitialRegistrationProcedure(ueContext *context.UEContext) {


	// New UE
	ue := context.NewUeRanContext(fmt.Sprintf("imsi-%s", ueContext.SUPIorSUCI), 1, security.AlgCiphering128NEA0, security.AlgIntegrity128NIA2)
...
<<<<<<< HEAD:src/ue/procedures/registration.go
...
=======
	...
	//pingLog.Infoln("Keep proccess active for 5 hours...")
>>>>>>> c8936b3e27f9973c7909ede0e4a471d1531fc9e1:ue_procedures/registration.go
	time.Sleep(5 * time.Hour)
}

func setUESecurityCapability(ue *context.UeRanContext) (UESecurityCapability *nasType.UESecurityCapability) {
...
func HandleRegistrationProcedure(ueContext *context.UEContext){
...
func HandleDeregistrationProcedure(ueContext *context.UEContext){

}

func SetupPDUSession(ueContext *context.UEContext){

}

func DeregistrationProcedure(ueContext *context.UEContext) {
