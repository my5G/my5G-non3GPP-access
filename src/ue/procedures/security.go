...
func NASEncode(ue *context.UeRanContext, msg *nas.Message, securityContextAvailable bool, newSecurityContext bool) (
...
func NASDecode(ue *context.UeRanContext, securityHeaderType uint8, payload []byte) (msg *nas.Message, err error) {
	if ue == nil {
		err = fmt.Errorf("amfUe is nil")
		return
	}
